...
def attack(char_name: str, char_class: str) -> str:
    """Функция возвращает результат при ипользовании команды 'attack'."""
    ...
    return (f'{char_name} не использовал атаку')


def defence(char_name: str, char_class: str) -> str:
    """Функция возвращает результат при ипользовании команды 'defence'."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не использовал блокирование')


def special(char_name: str, char_class: str) -> str:
    """Функция возвращает результат при ипользовании команды 'special'."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция тренировки.
    Проверяет класс персонажа, вызывает функции
    'attack', 'defence', 'special' в зависимости от введенной команды.
    """
    if char_class == 'warrior':
...
def main():
    """Приветствие.
    Запрашивает имя персонажа, за которого
    пользователь будет играть, запускает различные функции для игры.
    """
